...
export default function skills({}: Props) {
  return (
    <div id='skills' className='w-full lg:h-screen p-2  md:h-screen  py-16'>
      <div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full m-auto px-2 py-16 w-full'>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8 py-3'>
          <div className='grid grid-cols-2 p-6 bg-blue-100 rounded-full hover:scale-105 ease-in duration-300 items-center justify-center gap-4'>
